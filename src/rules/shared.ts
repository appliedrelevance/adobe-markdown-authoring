...
export const blocktags_with_options = ["TAB", "BEGINSHADEBOX", "BEGINTABS"];

export const inlinetags = ["UICONTROL", "DNL", "__BETA_", "BADGE"];
...
export const slugify = (str: string) => {
  var slug: string = encodeURIComponent(
...
export const clearHtmlCommentText = (text: string) => {
  ...
  while ((i = text.indexOf(htmlCommentBegin, i)) !== -1) {
    ...
    if (
      ...
      !comment.includes(htmlCommentBegin) &&
      !comment.includes(htmlCommentEnd) &&
...
export const headingStyleFor = function headingStyleFor(
...
export const forEachLine = function forEachLine(
  callback: (
    arg0: any,
    arg1: any,
    arg2: boolean,
  ...
  // Invoke callback
  tokenCache?.params.lines.forEach(function forLine(
    line: any,
...
export const forEachInlineChild = function forEachInlineChild(
  params: FilterParams,
  type: any,
...
export const forEachHeading = function forEachHeading(
  params: FilterParams,
  callback: (heading: MarkdownItToken, content: string) => void
) {
